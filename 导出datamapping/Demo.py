...
def gbase_pool():
    ...
    #     host='172.16.166.170',  # 主机号
    #     port=5258,  # 端口号
    #     user='gbase',  # 用户名
    #     password='gbase20110531',  # 密码
    #     database='etl_bl',  # schema
    #     charset='utf8',  # 数据库编码
...
if __name__ == "__main__":
    ...
    for i, line in enumerate(datamapping_task):
        ...
        cell.font = f
        # print(list(datamapping_head)[1:])
        sheet.append([cell] + list(datamapping_head)[1:])

        # workbook[line[1]]["A1"] = f'=HYPERLINK("#目录!B{i + 2}","返回")'
        # workbook[line[1]]["A1"].font = Font(color=colors.BLUE, underline="single")  # 设置文字样式
